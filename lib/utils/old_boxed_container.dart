...
///
/// [OldBoxedContainer] essentially calls an instance of [Container] with
/// a default decoration if one is not specifically given. [OldBoxedContainer]
/// defaults to [Container] if [AppData.drawLayoutBounds] is false.
class OldBoxedContainer extends StatelessWidget with GetItMixin {
  OldBoxedContainer({
    Key? key,
    this.alignment,
    this.borderColor,
